...
public class Pharmacy implements ActionListener
{
    ...
    JLabel heading;
    JButton show;
    JButton punch_attendance,add_medicine,show_medicine;
    JFrame f;
    Member m;
    Pharmacy(Member m)
    {
        this.m=m;
        f=new JFrame("Pharmacy page");
        ...
        add_medicine=new JButton("Enter medicine");
        add_medicine.setFont(new Font("Candara",0,18));
        add_medicine.setBounds(150,70,200,40);
        show_medicine=new JButton("Show medicine");
        show_medicine.setFont(new Font("Candara",0,18));
        show_medicine.setBounds(150,120,200,40);
        p2.add(punch_attendance);        
        p2.add(add_medicine);  
        p2.add(show_medicine);
        ...
        show_medicine.addActionListener(this);
    ...
    {
        new Pharmacy(new Member(103,"ranjeet","8279544933","ran002",3));
    }
}
